...
a = (C.c_int(3), C.c_int(4), C.c_int(5))
a2 = (C.c_int * 3) (3,4,5)
b = (C.c_int(5), C.c_int(4), C.c_int(3))
b2 = (C.c_int * 3) (5,4,3)
c = (C.c_int(), C.c_int(), C.c_int())
c2 = (C.c_int * 3) (0,0,0)
out = lib.add_int_array(C.byref(a2), C.byref(b2), C.byref(c2), C.c_int(3))
print(c2[1])
